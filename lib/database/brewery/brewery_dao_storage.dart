...
class _BreweryDaoStorage extends DatabaseAccessor<BeerAppDatabase> with _$_BreweryDaoStorageMixin implements BreweryDaoStorage {
  ...
  @override
  Future<void> createBreweryWithValue(Brewery brewery) async => into(db.dbBreweryTable)
      .insert(DbBreweryTableCompanion.insert(id: brewery.id, name: brewery.name, address: brewery.address, city: brewery.city, country: brewery.country));
